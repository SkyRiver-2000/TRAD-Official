...
from agents.trad import eval_traj_sample
...
def create_parser():
    ...
    parser.add_argument("--with_prev", action="store_true", default=False)
    parser.add_argument("--with_mark", action="store_true", default=False)
    parser.add_argument("--forward_step", type=int, default=0)
